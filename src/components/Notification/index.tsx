...
const Notification: React.FC = () => {
    ...
    const { customize, active, IslandHidden } = useRoastWidget();
    ...
    const repeatDelay = customize?.notifications?.repeatDelay ?? defaultCustomize?.notifications?.repeatDelay ?? 15;
    const displayDuration =
        customize?.notifications?.displayDuration ?? defaultCustomize.notifications?.displayDuration ?? 5;

    const parmanentDismissalExpiryDays =
        customize?.notifications?.paramanentDismissalExpiryDays ??
        defaultCustomize?.notifications?.paramanentDismissalExpiryDays ??
        dismissalExpiryDays;
